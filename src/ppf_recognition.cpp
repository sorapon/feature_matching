...
const Eigen::Vector4f subsampling_leaf_size (0.005f, 0.005f, 0.005f, 0.0f);
const float normal_estimation_search_radius = 0.007f;
...
main (int argc, char** argv)
{
  ...
  for (size_t model_i = 0; model_i < cloud_models.size (); ++model_i)
  {
    ...
    ppf_registration.setPositionClusteringThreshold (0.05f);
