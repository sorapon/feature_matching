...
//ros::NodeHandle n;
//ros::Publisher pub = n.advertise<pcl::PointCloud<pcl::PointXYZRGBA> > ("rotated_model", 1);
...
cloud_cb (const sensor_msgs::PointCloud2ConstPtr& input)
{
  ...
  if (use_hough_)
  {
    ...
    std::cout << clustered_corrs.size() << std::endl;
  }
...
main (int argc, char *argv[])
{
  ...
  ros::init (argc, argv, "SHOT_matching");
  ros::NodeHandle nh;
